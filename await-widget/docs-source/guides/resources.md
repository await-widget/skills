...
Use separate SVG or image files for content that would require many TSX nodes, keeping `index.tsx` small. Keep simple fills and basic shapes in TSX when they stay readable.
...
For audio assets, pass the local file path to the relevant audio API.
